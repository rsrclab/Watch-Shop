    ...
    $.fn.multiscroll = function(options) {
        ...
        */
        ...
        function silentScroll(){
            ...
            if (options.responsiveWidth >= windowWidth) {
                ...
                if(options.css3){
                    ...
                    $('.ms-left').css('left', -$('.ms-left').find('.ms-section.active').position().left );
                    $('.ms-right').css('right', $('.ms-right').find('.ms-section.active').position().left - 2 * windowWidth );
                }
            } else {
                if(options.css3){
        ...
        function scrollPage(leftDestination){
            ...
            var leftPos = {
                'left' : leftDestination.position().left,
                'right': rightDestination.position().left - 2 * windowWidth
            };
            ...
            if (options.responsiveWidth >= windowWidth) {
                if (options.css3){
                    ...
                    var translate3dLeft = 'translate3d(-' + leftPos['left'] + 'px, 0px, 0px)';
                    var translate3dRight = 'translate3d(' + leftPos['left'] + 'px, 0px, 0px)';
